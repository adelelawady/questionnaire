...
/**
 * REST controller for managing {@link app.questionaire.org.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
public class ApplicationUserResource {
    ...
    public ResponseEntity<ApplicationUserDTO> updateApplicationUser(@RequestBody ApplicationUserDTO applicationUserDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, applicationUserDTO.getId()))
            .body(result);
    }
